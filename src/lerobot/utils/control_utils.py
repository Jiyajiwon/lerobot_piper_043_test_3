...
def init_keyboard_listener():
    ...
    events["intervention_mode"] = False # jiwon    
    ...
    def on_press(key):
        try:
            if key == keyboard.Key.right:
                ...
                print("Intervention mode ON. Policy OFF.")
                events["intervention_mode"] = True
            elif hasattr(key, 'char') and key.char == 'p':
                print("Intervention mode OFF. Policy ON.")
                events["intervention_mode"] = False
